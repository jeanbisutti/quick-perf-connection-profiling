...
public class ProfileConnectionTest {
    ...
    should_profile_connection() throws IOException {
        ...
        .isEqualToNormalizingNewlines(
                        ...
                        "\tProfileConnectionTest$ProfileConnectionClass.test(ProfileConnectionTest.java:56)\n" +
                        "connection id - prepare statement with select isbn from Book (SQL)\n" +
                        "\tProfileConnectionTest$ProfileConnectionClass.test(ProfileConnectionTest.java:57)\n" +
                        "connection id - closed\n" +
                        "\tProfileConnectionTest$ProfileConnectionClass.test(ProfileConnectionTest.java:59)")
        ;
