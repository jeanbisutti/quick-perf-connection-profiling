...
public class ProfileConnectionJUnit4Test {
    ...
    should_profile_database_connection() throws IOException {
        ...
        .isEqualToNormalizingNewlines(
                                "connection id - the datasource gets the connection" + System.lineSeparator() +
                                ...
                                "\torg.quickperf.sql.SqlTestBaseJUnit4.getConnection(SqlTestBaseJUnit4.java:64)" + System.lineSeparator() +
                                "\torg.quickperf.sql.ProfileConnectionJUnit4Test$ProfileConnectionClass.test(ProfileConnectionJUnit4Test.java:54)" + System.lineSeparator() +
                                "connection id - prepare statement with select isbn from Book (SQL)" + System.lineSeparator() +
                                "\torg.quickperf.sql.ProfileConnectionJUnit4Test$ProfileConnectionClass.test(ProfileConnectionJUnit4Test.java:55)" + System.lineSeparator() +
                                "connection id - closed" + System.lineSeparator() +
                                "\torg.quickperf.sql.ProfileConnectionJUnit4Test$ProfileConnectionClass.test(ProfileConnectionJUnit4Test.java:57)");
